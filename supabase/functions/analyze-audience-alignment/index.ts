...
1. AUDIENCE ALIGNMENT (0-10): This dimension measures TARGETING ONLY — do the captions, topics, and framing of these recent posts speak to "${targetAudience}"'s actual problems, in their language, at their awareness level? A post that clearly names this audience's exact situation, fears, and constraints is a 9-10 on its own — score it that high even if the post has zero testimonials, proof, or success stories. Whether the content is convincing enough to close the sale (testimonials, credibility, track record) is NOT part of this score; that belongs to dimension 2 or the summary below, never to a deduction here. ${noEmulationProfiles ? "Score against industry benchmarks since no emulation profiles were provided." : "Compare to the emulation profiles — are they reaching similar people with similar language?"}

2. CONTENT UNIQUENESS (0-10): Does the hook style, angle, and topic selection stand out in this niche, or does it blend into generic content? Consider: distinctive personal stories, specific client results or success stories, testimonials, memorable hooks vs templated captions. Judge the SAMPLE as a whole — if most posts are distinctive with only a few templated ones, that's a 7-8, not a 5.
