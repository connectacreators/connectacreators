...
const TOOL_HINTS: Record<string, SceneHint> = {
  ...
  get_followup_workflow:       { scene: "scanning", verb: "Reading your follow-up workflow",meta: "followup_workflows" },
  add_followup_step:           { scene: "drafting", verb: "Adding a follow-up step",        meta: "followup_workflows" },
  get_social_account_status:   { scene: "scanning", verb: "Checking social connections",    meta: "social_connections" },
  get_subscription_info:       { scene: "scanning", verb: "Reading your subscription",      meta: "subscriptions" },
  list_trainings:              { scene: "scanning", verb: "Listing trainings",              meta: "trainings" },
  list_contracts:              { scene: "scanning", verb: "Listing contracts",              meta: "contracts" },
