export const t = {
  ...
  scripts: {
    ...
    inspirationUrl: { en: "The winning idea — link (optional)", es: "La idea ganadora — enlace (opcional)" },
    formatReferenceCreate: { en: "How to film & edit it — link (optional)", es: "Cómo grabarlo y editarlo — enlace (opcional)" },
