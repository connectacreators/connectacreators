                ...
                {signedUrl ? (
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {/* Track */}
                        <div className="w-full h-[3px] rounded-full bg-[rgba(20,20,20,0.08)] relative overflow-hidden">
                          <div
            ...
            <>
              ...
              <div className="px-3 py-3 space-y-2.5">
                ...
                {d.transcriptionStatus === "done" && !isProcessing && (
                  <div className="flex items-center gap-1.5 px-2 py-1.5 rounded-lg bg-[rgba(143,208,213,0.10)] border border-[rgba(143,208,213,0.25)]">
                    <CheckCircle2 className="w-3.5 h-3.5 text-[#8FD0D5] flex-shrink-0" />
                    <span className="text-[11px] text-[#8FD0D5] font-medium">Ready for AI</span>
                  </div>
                )}
                          ...
                          <div className="flex flex-wrap gap-1">
                            {seg.text_on_screen.map(
                              (txt: string, j: number) => (
                                <span
                                  key={j}
                                  className="text-[9px] px-1.5 py-0.5 rounded bg-[rgba(20,20,20,0.05)] border border-[rgba(20,20,20,0.12)] text-[#8FD0D5]/80"
                                >
                                  {txt}
                                </span>
                              )
