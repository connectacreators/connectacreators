            ...
            <>
              ...
              <div className="px-3 py-3 space-y-2.5">
                ...
                {d.transcriptionStatus === "done" && !isProcessing && (
                  <div className="flex items-center gap-1.5 px-2 py-1.5 rounded-lg bg-[hsl(var(--aqua) / 0.10)] border border-[hsl(var(--aqua) / 0.25)]">
                    <CheckCircle2 className="w-3.5 h-3.5 text-[hsl(var(--aqua))] flex-shrink-0" />
                    <span className="text-[11px] text-[hsl(var(--aqua))] font-medium">Ready for AI</span>
                  </div>
                )}
                          ...
                          <div className="flex flex-wrap gap-1">
                            {seg.text_on_screen.map(
                              (txt: string, j: number) => (
                                <span
                                  key={j}
                                  className="text-[9px] px-1.5 py-0.5 rounded bg-[hsl(var(--ink-on-cream) / 0.05)] border border-[hsl(var(--ink-on-cream) / 0.12)] text-[hsl(var(--aqua))]/80"
                                >
                                  {txt}
                                </span>
                              )
