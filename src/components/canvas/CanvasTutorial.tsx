...
function AnimScriptBars() {
  const lines = [
    ...
    { dot: "hsl(var(--aqua))", bar: "hsl(var(--aqua) / 0.4)", delay: "0.2s" },
    { dot: "hsl(var(--honey))", bar: "hsl(var(--honey) / 0.4)",  delay: "0.4s" },
    { dot: "hsl(var(--aqua))", bar: "hsl(var(--aqua) / 0.4)", delay: "0.6s" },
  ];
  return (
  ...
  return (
    <>
      ...
      <div style={calloutStyle} key={animKey}>
        ...
        {/* Mini animation box */}
        <div style={{
          background: "hsl(var(--bone) / 0.03)", border: "1px solid hsl(var(--bone) / 0.07)",
        ...
        {/* Description */}
        <div style={{ fontSize: 11, color: "hsl(var(--bone) / 0.65)", lineHeight: 1.55, marginBottom: 10 }}>
          {STEPS[step].desc}
        </div>
            ...
            <div key={i} style={{
              ...
              {i === step && (
                <div style={{
                  ...
                  background: "linear-gradient(to right, transparent, hsl(var(--bone) / 0.55), transparent)",
        ...
        <div style={{ display: "flex", gap: 6 }}>
          ...
          <button
            onClick={finish}
            style={{
              flex: 1, background: "transparent", border: "1px solid hsl(var(--bone) / 0.07)",
              borderRadius: 8, padding: "6px 10px", fontSize: 11, color: "hsl(var(--bone) / 0.45)",
              cursor: "pointer",
            }}
          >
            Skip
