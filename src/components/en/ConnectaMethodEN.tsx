...
const steps = [
  "We create viral scripts tailored to your niche and personality",
  "You record with confidence using our guidance",
  "We edit and optimize for maximum retention",
  "We amplify winning content with ads",
  "Your brand gains visibility, authority, and momentum"
];

const ConnectaMethodEN = () => {
  return (
...
export default ConnectaMethodEN;
