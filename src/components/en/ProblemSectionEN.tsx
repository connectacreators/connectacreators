      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-4 tracking-tight">
            <span className="italic text-primary">Real results</span> across all platforms
          </h2>
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            @elabogadojonathan — Immigration Attorney dominating social media
          </p>
        </motion.div>
        ...
        >
          Real results from <span className="text-foreground font-medium">Jonathan Shaw</span> — Immigration Attorney
        </motion.p>
      </div>
