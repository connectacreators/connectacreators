...
const audiences = [
  ...
  { text: "Attorneys and legal brands", icon: Scale },
  ...
  return (
    <section className="relative py-24 md:py-32 bg-background overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6">
        ...
        >
          Who <span className="italic">Connecta</span> is for
        </motion.h2>
        ...
        >
          <p className="text-lg md:text-xl text-foreground">
            If you want to be <span className="text-primary font-medium">visible</span>, <span className="text-primary font-medium">trustworthy</span>, and <span className="text-primary font-medium">taken seriously</span> online, this is for you.
          </p>
        </motion.div>
      </div>
    </section>
