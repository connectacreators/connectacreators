        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            >
              ...
              >
                <p>
                  I started as a video editor and became a content strategist by obsessing over what actually makes content work. Along the way, I've helped generate over{" "}
                  <span className="text-primary font-semibold">215M+ views</span> on Instagram, TikTok, and YouTube by building systems that turn attention into real results.
                </p>
                <p>
                  Today, I help creators, professionals, and sales teams build brands with clear positioning, powerful storytelling, and scalable execution. Connecta Creators exists because good content isn't enough.{" "}
...
export default FounderSectionEN;
