  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "glass-ios border-border/50 hover:brightness-110 text-foreground",
        secondary:
          "glass-ios text-secondary-foreground hover:brightness-110",
        ghost: "hover:bg-accent/20 hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        hero: "gradient-hero text-white hover:scale-105 transition-bounce shadow-glow",
        glass: "glass-ios text-foreground hover:brightness-110 border-primary/20",
        cta: "bg-primary text-primary-foreground hover:bg-primary/90 transition-smooth shadow-soft hover:shadow-glow font-semibold"
      },
      size: {
