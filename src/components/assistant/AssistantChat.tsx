              ...
              msg.is_progress ? (
                ...
                <div className="flex gap-2 items-start">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="font-caslon-text text-xl leading-[1.75]">
                ...
                <div className="flex gap-2 items-start group/msg">
                  ...
                  <div className="text-foreground min-w-0 flex-1 relative pr-8">
                    {(() => {
                      ...
                      if (!deck) return <div className="font-caslon-text text-xl leading-[1.75]"><MarkdownText text={msg.content} /></div>;
                      ...
                      if (alreadyAnswered) {
                        return deck.preamble ? (
                          <div className="font-caslon-text text-xl leading-[1.75]"><MarkdownText text={deck.preamble} /></div>
                        ) : null;
                      }
                      return (
                        <>
                          {deck.preamble && (
                            <div className="mb-2 font-caslon-text text-xl leading-[1.75]">
          ...
          return (
            <div className="flex gap-2 items-start px-1 py-1">
              ...
              {liveText.includes("questions_deck") ? (
                ...
                <div className="text-foreground min-w-0 flex-1 streaming-bubble font-caslon-text text-xl leading-[1.75]">
