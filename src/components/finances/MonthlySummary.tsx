...
export function MonthlySummary({ income, expenses, settings, onSaveSettings, onExportCsv }: Props) {
  ...
  // Monthly view stays a simple standalone P&L — the year-to-date position
  // (loss carryforward, retained earnings, CPA detail) lives in the Annual tab.
      ...
      <dl className="space-y-1.5 text-sm">
        ...
        {isLoss && !editingSettings && (
          <p className="text-[10px] text-muted-foreground/70 italic leading-snug -mt-1">
            ...
            The Annual tab tracks how the loss nets against the rest of the year.
          </p>
        )}
        {editingSettings ? (
