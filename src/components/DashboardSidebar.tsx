  ...
  const getNavItems = (): NavEntry[] => {
    ...
    if (isUser) {
      ...
      return [
        ...
        { label: "Public Calendar", icon: Globe, path: selectedClientId ? `/clients/${selectedClientId}/content-calendar` : "/content-calendar" },
    ...
    return [
      ...
      { label: "Public Calendar", icon: Globe, path: ownClientId ? `/clients/${ownClientId}/content-calendar` : "/content-calendar" },
      { type: 'group', label: 'Sales' },
